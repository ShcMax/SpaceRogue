...
namespace Gameplay.Shooting
{
    ...
    public class ProjectileLazerConfig : ScriptableObject, IIdentityItem<string>
    {
        ...
        [field: SerializeField, Range(0.1f, 100f)] public float BeamLength { get; private set; } // ƒлина луча
        [field: SerializeField, Range(0.01f, 1)] public float BeamWidth { get; private set; } // Ўирина луча
